...
public class SysRoleController {
	...
	// 处理接收前端发送过来的数据数据转换为对应的数组类型
	@RequiresPermissions("sys:role:update")
	@RequestMapping("doUpdateObjectByArray")
	@ResponseBody
	public JsonResult doUpdateObject02(@RequestParam(value = "menuIds[]") String[] menuIds) {
		return null;
	}
	...
	/*
	 * @ExceptionHandler(ServiceException.class) public ModelAndView
	 * handleException( ServiceException e){ return null; }
	 */

	@RequiresPermissions("sys:role:create")
	@RequestMapping("doSaveObject")
	@ResponseBody
	public JsonResult doSaveObject(SysRole entity, String menuIds) {
